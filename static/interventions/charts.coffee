class Denigma.Charts
  ...
  constructor: (@selector)->
    ...
    @iconView = new Denigma.IconView(poser = @poser, resources ="static/interventions/resources", dur = @dur)
    @barView = new Denigma.BarView(poser =@poser,minW = 10,minH = 10, dur = @dur)
