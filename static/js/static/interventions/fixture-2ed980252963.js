...
(function() {
  ...
  Denigma.Fixture = (function(_super) {
    ...
    */
    ...
    function Fixture() {
      this.animal = new Denigma.Animal("mouse", "mus", 18, "mouse.png");
      this.manipulation = new Denigma.Manipulation("radiaction", "test grouped lived and mutated inside the reactor", "shiny.src");
    }
